...
module.exports = function *(argv) {
  ...
  if (directClone) { // Direct clone method
    ...
    let sr = require('rethinkdbdash')({host: sourceHost, port: sourcePort, buffer: 500})
    let tr = require('rethinkdbdash')({host: targetHost, port: targetPort, buffer: 500})
